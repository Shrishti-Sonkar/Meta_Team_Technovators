---
title: AegisOps-AI-Intelligent-Incident-Response-Benchmark
emoji: "\U0001F6A8"
colorFrom: red
colorTo: yellow
sdk: docker
...
$env:PYTHONPATH="."; uvicorn incident_commander_env.server.app:app --host 0.0.0.0 --port 8000
...
docker run -p 8000:8000 aegisops-ai
```

### HuggingFace Space

Live deployment: [YOUR_USERNAME-aegisops-ai.hf.space](https://YOUR_USERNAME-aegisops-ai.hf.space)
